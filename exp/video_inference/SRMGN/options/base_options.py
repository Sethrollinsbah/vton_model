...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--num_gpus", type=int, default=1, help="the number of gpus"
        )
        self.parser.add_argument(
            "--checkpoints_dir",
            type=str,
        ...
        # for setting inputs
        self.parser.add_argument(
            "--dataroot", type=str, default="dataset/VITON_traindata/"
        )
        self.parser.add_argument(
            "--resize_or_crop",
            type=str,
        ...
        self.parser.add_argument(
            "--tv_weight", type=float, default=0.1, help="weight for TV loss"
        )
        self.parser.add_argument(
