...
def add_all_arguments(parser, train):
    ...
    parser.add_argument(
        "--dataroot", type=str, default="./data/mpv/", help="path to dataset root"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="latest",
        help="which epoch to load when continue_train",
    )
    parser.add_argument(
        "--gpu_ids",
        nargs="+",
        default=[0],
        type=int,
        help="GPUs to use for training / inference",
    )
    ...
    parser.add_argument(
        "--spade_ks", type=int, default=3, help="kernel size of convs inside SPADE"
    )
    parser.add_argument(
        "--no_EMA",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.9999,
        help="decay in exponential moving averages",
    )
    parser.add_argument(
        "--z_dim", type=int, default=9, help="dimension of the latent z vector"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.05,
        help="Validation set size (fraction - not int).",
    )
    parser.add_argument(
        "--train_size",
        type=float,
        default=0.95,
        help="Train set size (fraction - not int).",
    )
    parser.add_argument(
        "--transform_cloth",
        action="store_true",
    ...
    if train:
        ...
        parser.add_argument(
            ...
            type=int,
            default=10000,
            help="frequency of saving the checkpoints",
        )
        parser.add_argument(
            "--freq_save_latest",
            type=int,
        ...
        parser.add_argument(
            ...
            type=int,
            default=2000,
            help="frequency of loss plot updates",
        )
        parser.add_argument(
            "--freq_fid",
            type=int,
        ...
        parser.add_argument(
            "--continue_train",
            action="store_true",
            help="resume previously interrupted training",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--lambda_lpips", type=float, default=1.0, help="weight for LPIPS loss"
        )
        parser.add_argument(
            "--add_l1_loss", action="store_true", help="if specified, add L1 loss"
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--add_pd_loss",
            action="store_true",
            help="if specified, add patch discriminator loss",
        )
        parser.add_argument(
            "--patch_size",
            type=int,
            default=0,
            help="patch size for patch discriminator",
        )
        parser.add_argument(
            "--no_balancing_inloss",
            action="store_true",
        ...
        parser.add_argument(
            ...
            type=str,
            default="./results/",
            help="saves testing results here.",
        )
