...
def write_results(
    preds, scales, centers, datadir, dataset, result_dir, input_size=[473, 473]
):
...
def get_arguments():
    ...
    parser.add_argument(
        "--pred-path", type=str, default="", help="Path to predicted segmentation."
    )
    parser.add_argument(
        "--gt-path", type=str, default="", help="Path to the groundtruth dir."
    )
